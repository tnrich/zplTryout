...
$jscomp.polyfill(
  ...
  function(e) {
    return e
      ? e
      : function(e, k) {
          const h = $jscomp.checkStringArgs(this, e, "startsWith");
          e += "";
          const f = h.length,
            g = e.length;
