...
$jscomp.polyfill(
  ...
  function(e) {
    ...
    const l = $jscomp.global.setTimeout;
    ...
    c.prototype.executeOnSettledCallbacks_ = function() {
      if (null != this.onSettledCallbacks_) {
        for (let b = this.onSettledCallbacks_, a = 0; a < b.length; ++a)
          b[a].call(), (b[a] = null);
    ...
    c.race = function(b) {
      return new c(function(a, f) {
        for (
          let k = $jscomp.makeIterator(b), d = k.next();
          !d.done;
          d = k.next()
        )
...
const Zebra = (function() {
  ...
  g.Printer = function(c) {
    ...
    this.clearRequestQueue = function() {
      const a = this.device_request_queue[0];
      this.device_request_queue = [];
    ...
    this.onResponse = function(a, f) {
      ...
      const b = d.device_request_queue[0];
      if (void 0 != f)
        try {
          a = new f(a);
        } catch (m) {
